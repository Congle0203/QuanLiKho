...
export class InventoryService {
    ...
    baseUrl = 'http://localhost:58406/api/Inventories/';
    ...
    getDetail(makho: any) {
        return this.http.get(this.baseUrl + makho);
    }
    ...
    update(inventory: Inventory) {
        return this.http.put(this.baseUrl+ '/' +inventory.makho, inventory);
    }

    delete(makho: any) {
        return this.http.delete(this.baseUrl + '/' + makho);
    }
