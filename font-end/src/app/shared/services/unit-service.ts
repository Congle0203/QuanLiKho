...
//     baseUrl = 'http://localhost:56920/api/Units';
...
export class UnitService {
    ...
    baseUrl = 'http://localhost:58406/api/Units/';
    ...
    getDetail(madv: any) {
        return this.http.get(this.baseUrl + madv);
    }
    ...
    update(unit: Unit) {
        return this.http.put(this.baseUrl+ unit.madv, unit);
    }

    delete(madv: any) {
        return this.http.delete(this.baseUrl + madv);
    }
}
