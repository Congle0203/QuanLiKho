...
namespace Web.API.Controllers
{
    ...
    public class StocksController : Controller
    {
        ...
        {
            PagedList<StocksItemViewModel> paged = await _stockRepository.GetAllPagingAsync(pagingParams);
        ...
        {
            var result = await _stockRepository.DeleteWithName(resource.Tenvt);
